    ...
    <section id="services" className="py-20 bg-muted/30">
      <div className="container mx-auto px-4">
        <div className="text-center mb-14">
          <span className="text-sm font-medium text-primary bg-accent rounded-full px-4 py-1.5 inline-block mb-4">الخدمات</span>
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-3">الخدمات المتاحة</h2>
          <p className="text-muted-foreground max-w-md mx-auto">اكتشف مجموعة واسعة من الخدمات الاحترافية التي يقدمها أفضل المستقلين</p>
        </div>
        ...
        <div className="text-center">
          <Button variant="outline" className="rounded-full px-8">عرض جميع الفئات</Button>
        </div>
      </div>
    </section>
  );
