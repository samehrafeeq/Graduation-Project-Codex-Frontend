    ...
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-1.5 rounded-full border border-white/20 mb-6 animate-fade-in">
          ...
          <span className="text-white font-medium text-sm">انضم لمجتمع المبدعين</span>
        </div>
        
        <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6 leading-tight">
          مستعد لبدء <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-200 to-yellow-400">رحلتك؟</span>
        </h2>
        
        <p className="text-indigo-100 mb-10 max-w-2xl mx-auto text-lg md:text-xl leading-relaxed">
          انضم إلى آلاف المستخدمين الذين يثقون بمنصة خدماتي لإنجاز أعمالهم وزيادة دخلهم. 
          سجل الآن وابدأ في دقائق.
        </p>
