      ...
      <div className="relative z-10 w-full max-w-[600px] px-4 animate-in fade-in zoom-in-95 duration-500">
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex items-center justify-center gap-2 mt-6 dir-rtl">
            <div className={`h-2 rounded-full transition-all duration-500 ${step >= 1 ? "w-8 bg-primary" : "w-2 bg-muted"}`} />
            <div className={`h-2 rounded-full transition-all duration-500 ${step >= 2 ? "w-8 bg-primary" : "w-2 bg-muted"}`} />
            <div className={`h-2 rounded-full transition-all duration-500 ${step >= 3 ? "w-8 bg-primary" : "w-2 bg-muted"}`} />
          </div>
        </div>
                ...
                <div className="grid md:grid-cols-2 gap-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      ...
                      <Input id="name" placeholder="الاسم كما في الهوية" value={form.name} onChange={(e) => setForm({...form, name: e.target.value})} className="pr-10 h-11 bg-background border-input focus:bg-background focus:border-primary rounded-xl" required />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2 md:col-span-2">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">سيتم استخدام هذا الرقم للتحقق عبر واتساب</p>
                  </div>
                 ...
                 <div className="flex items-start gap-2 bg-muted/40 p-3 rounded-lg border border-border">
                    <Checkbox id="terms" className="rounded-[4px] border-input data-[state=checked]:bg-primary data-[state=checked]:border-primary mt-0.5" required />
              ...
              <form className="space-y-8 animate-in fade-in slide-in-from-right-10 duration-500" onSubmit={handleKYCSubmit}>
                ...
                <div className="space-y-3">
                   ...
                   <div className="grid grid-cols-2 gap-4">
                      {/* Upload ID Button */}
                      <label className="h-32 border border-border rounded-xl flex flex-col items-center justify-center gap-2 hover:bg-muted/40 hover:border-border transition-all text-muted-foreground group cursor-pointer">
                      ...
                      {/* Preview */}
                      <div className="h-32 border border-border rounded-xl flex flex-col items-center justify-center gap-2 text-muted-foreground">
                         {idFile ? (
                   ...
                   <p className="text-xs text-muted-foreground mr-1">يجب أن تكون الصورة واضحة وتظهر كافة البيانات (الوجه الأمامي).</p>
                </div>
                ...
                <div className="space-y-3">
                   ...
                   <div className="grid grid-cols-2 gap-4">
                      ...
                      <label className="h-32 border border-border rounded-xl flex flex-col items-center justify-center gap-2 hover:bg-muted/40 hover:border-border transition-all text-muted-foreground cursor-pointer">
                         <ScanFace size={24} className="text-muted-foreground" />
                   ...
                   <p className="text-xs text-muted-foreground mr-1">يجب أن تكون الصورة حديثة واضحة وبدون فلاتر أو نظارات شمسية.</p>
                </div>

                <div className="flex gap-3">
                   <Button type="button" variant="outline" onClick={() => setStep(1)} className="flex-1 h-12 rounded-xl border-border hover:bg-muted/40 text-muted-foreground">
                      رجوع
                   </Button>
